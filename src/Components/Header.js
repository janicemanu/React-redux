...
class Header extends Component {
    ...
    render(){
        ...
        if(user.username ===''){
            ...
            //                                 <Link className="nav-a" to="/ManageProduct">All Product</Link>
            //                             </li>
            ...
            return (
                <div>
                    <Navbar color="light" light expand="md">
                        <div className="container">
                            <NavbarBrand href="/">TokoLapak</NavbarBrand>
                            <NavbarToggler onClick={this.toggle} />
                            <Collapse isOpen={this.state.isOpen} navbar>
                                <Nav className="ml-auto" navbar>
                                    <NavItem>
                                    ...
                                    <UncontrolledDropdown nav inNavbar>
                                        ...
                                        <Button className="dropdown-item" onClick={this.props.onLogoutClick}>
                                            Log out
                                        </Button>
                ...
                //                                 <button onClick={this.props.onLogoutClick} className="dropdown-item">Logout</button>
                //                             </div>
                //                         </li>
                //                         {/* <li className="nav-item m-1">
...
export default connect(mapStateToProps,{onLogoutClick})(Header);